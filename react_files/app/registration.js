    ...
    return (
        ...
        <View style={styles_register.container}>
            ...
            <View style={styles_register.containerPassRegWindow}>
                ...
                <Text style={styles_register.regFormText}>Hasssło</Text>
                ...
                <TextInput style={styles_register.regForm} placeholder="..."  autoCapitalize="none" placeholderTextColor="#B3B3B3" onChangeText={(text) => setDateOfBirth(text)} value={dateOfBirth}></TextInput>
                <Text style={styles_register.regFormText}>PESEL</Text>
                <TextInput style={styles_register.regForm} placeholder="..." autoCapitalize="none" placeholderTextColor="#B3B3B3" onChangeText={(text) => setPesel(text)} value={pesel}></TextInput>
                ...
                {/* <TouchableOpacity style={[styles_register.SubmitButton, (email1 !== '' && email2 !== '') ? styles_register.SubmitButtonPressed : null,]} onPress={recoverPress}>
                    <Text style={[styles_register.SubmitText, (email1 !== '' && email2 !== '') ? styles_register.SubmitTextPressed : null,]}>ODZYSKAJ</Text>
                </TouchableOpacity> */}
            </View>
